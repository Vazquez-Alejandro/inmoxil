  ...
  return (
    <aside className="w-64 h-full bg-gradient-dark flex flex-col overflow-hidden">
      <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-navy-400 text-[10px] uppercase tracking-widest font-medium dark:text-navy-300">Plataforma en la nube</p>
          </div>
        </div>
        <button
          onClick={onClose}
          className="lg:hidden p-1 rounded text-navy-400 hover:text-white dark:text-navy-300"
        >
      ...
      <div className="px-3 py-4 border-t border-white/10 shrink-0">
        ...
        <button
          onClick={() => signOut()}
          className="flex items-center gap-3 mt-3 px-4 py-2 rounded-lg text-sm font-medium text-navy-400 hover:text-white hover:bg-white/10 transition-all duration-150 w-full dark:text-navy-300"
        >
...
function ExpensasIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
...
function WrenchIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.595 5.595a2.015 2.015 0 01-2.828 0L2.85 16.004a2.015 2.015 0 010-2.828l5.595-5.595m4.296 4.296l5.595-5.595a2.015 2.015 0 000-2.828L16.004 2.85a2.015 2.015 0 00-2.828 0L7.581 8.445m5.595 5.595l-2.828-2.828" />
    </svg>
  )
}
