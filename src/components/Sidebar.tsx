    ...
    <aside className="w-64 h-full bg-gradient-dark flex flex-col">
      ...
      <div className="px-3 py-4 border-t border-white/10">
        ...
        <div className="flex items-center gap-3 mt-3 px-1">
          <Link href="/terminos" target="_blank" className="text-navy-500 hover:text-navy-300 text-[10px] transition-colors">Términos</Link>
          <span className="text-navy-600 text-[10px]">·</span>
          <Link href="/privacidad" target="_blank" className="text-navy-500 hover:text-navy-300 text-[10px] transition-colors">Privacidad</Link>
        </div>
      </div>
    </aside>
  )
