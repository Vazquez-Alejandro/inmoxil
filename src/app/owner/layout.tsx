        ...
        <aside className="w-64 h-full bg-gradient-dark flex flex-col overflow-hidden">
          <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-navy-400 text-[10px] uppercase tracking-widest font-medium dark:text-navy-300">Propietario</p>
              </div>
            </div>
            <button onClick={() => setSidebarOpen(false)} className="lg:hidden p-1 rounded text-navy-400 hover:text-white dark:text-navy-300">
          ...
          <div className="px-4 py-4 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-navy-400 text-xs truncate dark:text-navy-300">{owner.email}</p>
              </div>
            </div>
          </div>
          ...
          <div className="px-3 py-4 border-t border-white/10 shrink-0 space-y-2">
            <button
              ...
              className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium text-navy-400 hover:text-white hover:bg-white/10 transition-all duration-150 w-full dark:text-navy-300"
            >
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen">
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-200 sticky top-0 z-30">
          <button onClick={() => setSidebarOpen(true)} className="p-2 rounded-lg hover:bg-gray-100">
            <svg className="w-5 h-5 text-navy-700 dark:text-navy-300" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <footer className="px-4 sm:px-6 lg:px-8 py-4 border-t border-gray-200 mt-auto">
          <div className="flex items-center justify-center gap-4 text-xs text-navy-400 dark:text-navy-300">
            <Link href="/terminos" target="_blank" className="hover:text-navy-600 transition-colors dark:text-navy-400">Términos y Condiciones</Link>
            <span>·</span>
            <Link href="/privacidad" target="_blank" className="hover:text-navy-600 transition-colors dark:text-navy-400">Política de Privacidad</Link>
          </div>
        </footer>
      </div>
    </div>
