...
export default function OwnerDashboardPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-navy-900 dark:text-white">Panel</h1>
        <p className="text-sm text-navy-500 mt-1 dark:text-navy-400 dark:text-navy-300 dark:text-navy-100">
          Bienvenido/a, {owner?.name || 'Propietario'}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {statCards.map(s => (
          <Link key={s.label} href={s.href} className="card p-5 hover:shadow-md transition-shadow group">
            ...
            <p className="text-xs text-navy-500 mt-0.5 dark:text-navy-400 dark:text-navy-300 dark:text-navy-100">{s.label}</p>
          </Link>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card p-6">
          <h3 className="text-lg font-bold text-navy-900 mb-4 dark:text-white">Acceso rápido</h3>
          <div className="space-y-3">
            <Link href="/owner/propiedades" className="flex items-center gap-3 p-3 rounded-xl bg-indigo-50 hover:bg-indigo-100 transition-colors group">
              ...
              <div><p className="font-medium text-navy-900 dark:text-white">Ver mis propiedades</p><p className="text-xs text-navy-500 dark:text-navy-400 dark:text-navy-300 dark:text-navy-100">Listado completo de tus inmuebles</p></div>
            </Link>
            <Link href="/owner/contratos" className="flex items-center gap-3 p-3 rounded-xl bg-emerald-50 hover:bg-emerald-100 transition-colors group">
              ...
              <div><p className="font-medium text-navy-900 dark:text-white">Mis contratos</p><p className="text-xs text-navy-500 dark:text-navy-400 dark:text-navy-300 dark:text-navy-100">Consultá tus contratos activos</p></div>
            </Link>
            <Link href="/owner/mantenimiento" className="flex items-center gap-3 p-3 rounded-xl bg-amber-50 hover:bg-amber-100 transition-colors group">
              ...
              <div><p className="font-medium text-navy-900 dark:text-white">Mantenimiento</p><p className="text-xs text-navy-500 dark:text-navy-400 dark:text-navy-300 dark:text-navy-100">Seguimiento de tickets</p></div>
            </Link>
          </div>
        </div>

        <div className="card p-6">
          <h3 className="text-lg font-bold text-navy-900 mb-4 dark:text-white">Resumen</h3>
          {owner ? (
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-navy-900 text-lg dark:text-white">{owner.name}</h4>
                  <p className="text-sm text-navy-500 dark:text-navy-400 dark:text-navy-300 dark:text-navy-100">{owner.email}</p>
                  {owner.phone && <p className="text-sm text-navy-400 dark:text-navy-300 dark:text-navy-100">{owner.phone}</p>}
                </div>
              </div>
              <div className="bg-navy-50 rounded-xl p-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-xs text-navy-400 dark:text-navy-300 dark:text-navy-100">Propiedades</p>
                    <p className="text-xl font-bold text-navy-900 dark:text-white">{stats.totalProperties}</p>
                  </div>
                  <div>
                    <p className="text-xs text-navy-400 dark:text-navy-300 dark:text-navy-100">Contratos activos</p>
                    <p className="text-xl font-bold text-navy-900 dark:text-white">{stats.activeContracts}</p>
                  </div>
                  <div>
                    <p className="text-xs text-navy-400 dark:text-navy-300 dark:text-navy-100">Total contratos</p>
                    <p className="text-xl font-bold text-navy-900 dark:text-white">{stats.totalContracts}</p>
                  </div>
                  <div>
                    <p className="text-xs text-navy-400 dark:text-navy-300 dark:text-navy-100">Tickets abiertos</p>
                    <p className="text-xl font-bold text-navy-900 dark:text-white">{stats.openTickets}</p>
                  </div>
                </div>
              </div>
            </div>
