          ...
          {workspace ? (
            <div className="space-y-4">
              ...
              {(() => {
                ...
                return (
                  <div className="bg-navy-50 dark:bg-navy-800 rounded-xl px-4 py-3">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs font-semibold text-navy-500 dark:text-navy-400 uppercase tracking-wider">Plan {plan.nameEs}</span>
                      <span className="text-xs text-navy-500 dark:text-navy-400">${plan.price}/mes</span>
                    </div>
                    <Link href="/dashboard/billing" className="block w-full text-center text-xs text-emerald-600 dark:text-emerald-400 font-medium py-1.5 rounded-lg border border-emerald-200 dark:border-emerald-500/30 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-colors">
