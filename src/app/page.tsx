      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 md:pt-24 pb-16 md:pb-20 relative">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4">
            ...
            <a
              href="#precios"
              className="inline-flex items-center justify-center gap-2 border border-white/20 text-white hover:bg-white/10 text-lg px-10 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 flex-1"
            >
              Ver precios
