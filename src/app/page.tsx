      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 md:pt-24 pb-16 md:pb-20 relative">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4">
            <Link
              href="/register"
              className="inline-flex items-center justify-center gap-2 bg-gold-500 hover:bg-gold-400 text-navy-950 font-semibold text-lg px-10 py-4 rounded-xl shadow-lg shadow-gold-500/25 hover:shadow-gold-500/40 transition-all duration-200 hover:-translate-y-0.5 sm:w-1/2 w-full"
            >
            ...
            <a
              href="#precios"
              className="inline-flex items-center justify-center gap-2 border border-white/20 text-white hover:bg-white/10 text-lg px-10 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 sm:w-1/2 w-full"
            >
              Ver precios
